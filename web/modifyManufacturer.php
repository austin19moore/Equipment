               ...
               <div class="row">
                    <?php
                        ...
                        if ($result['Status'] == "ERROR") {
                            redirect("modifyManufacturer.php?msg=unknown");
                        }
                    ...
                    <form method="post" action="">
                        ...
                        <label for="exampleNew">Modify Manufacturer:</label>
                        <br><br>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="newManufacturerInput" name="newname">
                        </div>
...
<?php
     ...
     if (isset($_POST['submit']))
    {
        ...
        if ($active == NULL) {
            ...
            if (empty($oldname)) {
                redirect("modifyManufacturer.php?msg=empty");
            }

            if (strlen($newname) > 12) {
                redirect("modifyManufacturer.php?msg=manufacturerLength");
            }

           
            $url = "WEB_ADDRESS/api/modify_manufacturer?";
        $data = array(
            "oldname" => $oldname,
            "newname" => $newname,
            "active" => $active
        ...
        if ($result["Status"] == "SUCCESS") {
            ...
            if ($result["MSG"] == "New manufacturer already exists") {
                redirect("modifyManufacturer.php?msg=ManufacturerExists");
            } else if ($result["MSG"] == "Old manufacturer does not exist") {
                redirect("modifyManufacturer.php?msg=OldNotExist");
            } else if ($result["MSG"] == "Manufacturer name too long") {
                redirect("modifyManufacturer.php?msg=manufacturerLength");
            } else if ($result["MSG"] == "Manufacturer names cannot be empty") {
                redirect("modifyManufacturer.php?msg=empty");
            } else {
                redirect("modifyManufacturer.php?msg=unknown");
            }
