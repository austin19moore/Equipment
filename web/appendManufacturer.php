          ...
          <div class="container">
               <div class="row">
                    <?php
                        ...
                        if (isset($_REQUEST['msg']) && $_REQUEST['msg']=="ManufacturerLength")
                        {
                            echo '<div class="alert alert-danger" role="alert">Manufacturer name too long!</div>';
                    ...
                    <form method="post" action="">
                         ...
                         <label for="exampleNew">New Manufacturer:</label>
                         <br>
...
<?php
     ...
     if (isset($_POST['submit']))
    {
        $name=$_POST['name'];
          ...
          if (empty($name)) {
               redirect("appendManufacturer.php?msg=empty");
          }


          if (strlen($name) > 20) {
               redirect("appendManufacturer.php?msg=ManufacturerLength");
          }
          

          $url = "https://ec2-54-198-111-73.compute-1.amazonaws.com/api/add_manufacturer?";
        $data = array(
            "name" => $name
        );
        ...
        if ($result["Status"] == "SUCCESS") {
            ...
            if ($result["MSG"] == "Manufacturer already exists") {
                redirect("appendManufacturer.php?msg=ManufacturerExists");
            } else {
                redirect("appendManufacturer.php?msg=unknown");
            }
